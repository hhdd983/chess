...
if __name__ == "__main__":
    LICHESS_MASTER_USERNAMES = [
        ...
        "EYRTNR",         # Erol Yarataner
        "Nell0405"        # NeLL Liu
        "S_Evelyn"        # Stevelyn
        "qubala13"        # Kuba Pastewka
    ]
    # hahahahhadslknldjv
    GAMES_PER_USER = 10000

    MAX_SAMPLES_PER_USER = 500000
    ...
    for username in LICHESS_MASTER_USERNAMES:
        ...
        if pgn_string:
            X_user, y_user = process_pgn_string(
                pgn_string, username, max_samples_per_user=MAX_SAMPLES_PER_USER)
